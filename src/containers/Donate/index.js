    ...
    >
      ...
      <Container className="p-4">
        <Form
          ...
          style={{ margin: "0 auto" }}
        >
          <h3 className="text-center mb-4">{type} Form</h3>
          <FormGroup tag="fieldset">
            ...
            >
              <Label check className="col-3">
                <Input type="radio" name="radio1" value="oxygen" /> Oxygen
              </Label>
              <Label check className="col-3">
                <Input type="radio" name="radio1" value="plasma" /> Plasma
              </Label>
              <Label check className="col-3">
                <Input type="radio" name="radio1" value="medicine" /> Medicine
              </Label>
              <Label check className="col-3">
                <Input type="radio" name="radio1" value="bed" /> Bed
              </Label>
            </FormGroup>
          </FormGroup>
          <FormGroup>
          ...
          <Button
            onClick={() => handleSubmit("donarsList")}
            color="primary"
            size="lg"
            block
          >
